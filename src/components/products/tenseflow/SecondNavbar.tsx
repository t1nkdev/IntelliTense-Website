    ...
    <div className="w-full h-16 bg-white">
      <div className="h-full max-w-[70rem] mx-auto px-4 pt-1">
        <nav className="h-full flex items-center">
          <span className="text-[15px] font-bold text-black -ml-32 mr-6">Workforce Shift Management (WFM)</span>
          <Image src="/icons/flow.png" alt="Flow Icon" width={20} height={20} className="inline-block -ml-4 mr-4"/>
